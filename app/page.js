...
export default function Home() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section id="eventos" className="max-w-6xl mx-auto py-20 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[1, 2, 3].map((item) => (
            <div
              key={item}
              className="bg-white/5 border border-fuchsia-500/20 rounded-3xl p-6 hover:scale-105 transition"
            >
              ...
              <p className="text-gray-300 mb-4">
                Santiago · Comunidad queer premium.
              </p>
      ...
      <section id="comunidad" className="bg-fuchsia-950/20 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300">
            Luna en Lesbos nació para crear espacios seguros,
            entretenidos y reales para mujeres lesbianas y queer en Chile.
          </p>
        </div>
      </section>
      ...
      <section id="galeria" className="max-w-6xl mx-auto py-20 px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((item) => (
            <div
              key={item}
              className="h-64 rounded-3xl bg-gradient-to-br from-fuchsia-400/30 to-violet-600/30"
            ></div>
          ))}
        </div>
      </section>
      ...
      <footer
        id="contacto"
        className="border-t border-fuchsia-500/20 py-10 text-center text-gray-400"
      >
